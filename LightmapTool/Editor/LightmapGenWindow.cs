    ...
    public class LightmapGenWindow : CustomEditorWindowBase
    {
        ...
        public LightmapType LightType
        {
            ...
            set {
                ...
                {
                    Lighttype = value;
                    SetBakedNode(Lighttype);
                    SetLightingAmibent(Lighttype);
                }
            }
        }
        ...
        public void SetLightingAmibent(LightmapType type)
        {
            if (type == LightmapType.Morning)
                RenderSettings.ambientLight = LightmapTypeData.Inst.Ambient.Morning_AmbientColor;
            else
                RenderSettings.ambientLight = LightmapTypeData.Inst.Ambient.Evening_AmbientColor;
        }
...
//            lightmapContainer.TexturePackages = GenTexturePackages();
        ...
        private void SetBakedNode(LightmapType type)
        {
            ...
            for (int i = 0; i < go.transform.childCount; i++)
            {
                ...
                if (child.name == "baked")
                {
                    ...
                    {
                        var c = child.transform.GetChild(j);
                        if (c.name == "Morning")
                        {
                            if (type == LightmapType.Morning)
